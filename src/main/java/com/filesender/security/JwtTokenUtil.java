...
import static com.filesender.security.Constants.ACCESS_TOKEN_VALIDITY_SECONDS;
import static com.filesender.security.Constants.SIGNING_KEY;
...
public class JwtTokenUtil implements Serializable {
    ...
    private String doGenerateToken(String subject) {
        ...
        return Jwts.builder().setClaims(claims).setIssuer("https://co-operativebank.co.ke")
